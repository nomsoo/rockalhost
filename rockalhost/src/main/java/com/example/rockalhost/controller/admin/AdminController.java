...
public class AdminController {
	...
	public ModelAndView deletelist(ModelAndView mav, @RequestParam(defaultValue="1") int curPage) throws Exception {
		int bandCount = allbandService.bandCount();
		...
		List<AllbandViewDTO> list = allbandService.deletelist(map);	
		System.out.println("list = "+list);
		mav.setViewName("admin/band/deleteband");
		mav.addObject("list", list); 
		mav.addObject("bandCount", bandCount);
		mav.addObject("page", pager); 
		return mav; 
