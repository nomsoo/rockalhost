	...
	<div class="row row-offcanvas row-offcanvas-right">
		...
		<tr>
			...
			<td>
				...
				<a href="${path}/bandBoard/qbView.do?num=${dto.num}&b_idx=${b_idx}&curPage=${page.curPage}&pf_title=${dto.pf_title}">${dto.subject}</a>
			</td>
			<td>${dto.writer}</td>
			<td>
...
<table style="width: 930px">
	<tr align="center">
		<td>
		<form name="search_form" method="post" action="${path}/bandBoard/qbList.do">
